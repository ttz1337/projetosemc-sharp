...
namespace Course
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0} tem {1} anos e tem o saldo igual a {2} reais", n1, idade, saldo); //placeholder
            Console.WriteLine($"{n1} tem {idade} anos e tem o saldo igual a {saldo} reais"); //interpolação
